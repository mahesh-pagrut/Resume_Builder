  ...
  return (
    ...
    <div>
      ...
      <div className="main-container">
        <header className="primary-header" onClick={() => window.location.reload()}> <img className='mainLogo' src='https://i.ibb.co/5rQd1P4/freepik-candid-image-photography-natural-textures-highly-r-67441-Photoroom.png' alt='logo' style={{width:"500px", display:"inline" , marginBottom:'0', margin:'5px', filter:"drop-shadow(1px 1px 0px black)" }}/></header>
